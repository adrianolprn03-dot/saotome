...
export default function SocialPage() {
    ...
    useEffect(() => {
        const fetchUnidades = async () => {
            try {
                const res = await fetch("/api/unidades?tipo=social");
                if (res.ok) {
    ...
    return (
        <div>
            <PageHeader
                ...
                subtitle="Equipamentos de Assistência Social, CRAS e Conselho Tutelar"
                breadcrumbs={[
                    { label: "Início", href: "/" },
                    { label: "Serviços", href: "#" },
                    { label: "Social" }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {loading ? (
                            ...
                            <div className="md:col-span-2 text-center py-10 text-gray-500">
                                Nenhuma unidade de assistência social cadastrada no momento.
                            </div>
